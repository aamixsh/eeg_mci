...
if not os.path.exists(args.results_dir + '_' + args.rm_ch_str + '_samesplit'):
    os.makedirs(args.results_dir + '_' + args.rm_ch_str + '_samesplit')
if not os.path.exists(args.weights_dir + '_' + args.rm_ch_str + '_samesplit'):
    os.makedirs(args.weights_dir + '_' + args.rm_ch_str + '_samesplit')
...
for run in range(args.runs):
    ...
    train_pats, test_pats = get_train_test_pats_from_run(f'../eeg_raw/{args.results_dir}_{args.rm_ch_str}/{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}.txt', run)
    ...
    file = open(f'{args.results_dir}_{args.rm_ch_str}_samesplit/{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}.txt', 'a')
    ...
    torch.save(model.state_dict(), f'{args.weights_dir}_{args.rm_ch_str}_samesplit/{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}.pth')
