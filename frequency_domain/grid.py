...
parser = argparse.ArgumentParser(description='Run EEG Spectral Grid Search')
...
parser.add_argument('--norm_type', type=str, default='min')
...
conf_path = args.model_confs_path + '_' + args.model_type + '.txt'
