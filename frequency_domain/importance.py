...
#             filen.write('\n')
    ...
    np.save(f'{args.results_dir}_{args.rm_ch_str}/train_shap_imps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}/train_shap_negimps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', neg_imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}/train_preds{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', predictions.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}/train_targets{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', targets.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}/train_pat_ids{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', train_pat_ids)
...
#             filen.write('\n')
    ...
    np.save(f'{args.results_dir}_{args.rm_ch_str}/test_shap_imps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}/test_shap_negimps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', neg_imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}/test_preds{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', predictions.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}/test_targets{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', targets.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}/test_pat_ids{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', test_pat_ids)
