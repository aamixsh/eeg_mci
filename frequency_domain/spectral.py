...
parser.add_argument('--norm_type', type=bool, default='min')
...
for run in range(args.runs):
    print (args.study, args.treat, args.shuffle, args.filter_type, args.start_evt)
    ...
    file = open(f'{args.results_dir}/{args.study}_{args.treat}_{args.rm_ch_str}_{args.contig_len}{safe_str}_.txt', 'a')
...
#                         cnn = MLP(in_dim=in_dim, out_dim=args.num_classes)
    ...
    torch.save(cnn.state_dict(), f'{args.weights_dir}/{args.study}_{args.treat}_{args.remove_channels}_{args.start_evt}{safe_str}_{run}_split_{norm_type}.pth')
