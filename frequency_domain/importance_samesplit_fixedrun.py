...
#             filen.write('\n')
    ...
    pickle.dump(shaps, open(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_shaps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed.pkl', 'wb'))
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_shap_imps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed', imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_shap_negimps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed', neg_imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_preds{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed', predictions.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_targets{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed', targets.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_pat_ids{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed', train_pat_ids)
...
#             filen.write('\n')
    ...
    pickle.dump(shaps, open(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_shaps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed.pkl', 'wb'))
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_shap_imps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed', imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_shap_negimps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed', neg_imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_preds{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed', predictions.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_targets{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed', targets.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_pat_ids{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}_fixed', test_pat_ids)
