...
parser.add_argument('--contig_len', type=int, default=2000)
...
for run in range(args.runs):
    ...
    selected_run = np.random.randint(args.total_runs)
    ...
    train_pats, test_pats = get_train_test_pats_from_run(f'{args.results_dir}_{args.rm_ch_str}_samesplit/{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}.txt', selected_run)
    ...
    train_dataset = EEGSDataset(data_dict=data, locs=train_locs, study=args.study, treat=args.treat, norms=n, cuda=False)
    test_dataset = EEGSDataset(data_dict=data, locs=test_locs, study=args.study, treat=args.treat, norms=n, cuda=False)
    ...
    # Load weights
    model.load_state_dict(torch.load(f'{args.weights_dir}_{args.rm_ch_str}_samesplit/{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{selected_run}.pth'))
...
#             filen.write('\n')
    ...
    pickle.dump(shaps, open(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_shaps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}.pkl', 'wb'))
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_shap_imps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_shap_negimps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', neg_imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_preds{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', predictions.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_targets{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', targets.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/train_pat_ids{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', train_pat_ids)
...
#             filen.write('\n')
    ...
    pickle.dump(shaps, open(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_shaps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}.pkl', 'wb'))
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_shap_imps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_shap_negimps{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', neg_imps)
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_preds{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', predictions.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_targets{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', targets.numpy())
    np.save(f'{args.results_dir}_{args.rm_ch_str}_samesplit/test_pat_ids{allt}_{args.study}_{args.treat}_{args.contig_len}_{args.norm_type}_{args.balanced}_{run}', test_pat_ids)
