...
parser.add_argument('--data_path1', type=str,default='./data/kmci_kctrl_kdem')
parser.add_argument('--data_path2', type=str,default='../eeg_raw/data/wmci_wctrl')
...
if args.rm_ch_str != '':
    data_path2 = args.data_path2 + '_' + args.rm_ch_str +'_notevt_' + str(args.contig_len) + '_car.pkl'
else:
    data_path2 = args.data_path2 +'_notevt_' + str(args.contig_len) + '_car.pkl'
